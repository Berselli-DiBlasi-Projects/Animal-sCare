                    ...
                    <View style={{alignItems: 'center'}}>
                        <Card style={styles.inputContainer}>
                            ...
                            <View style={styles.buttonStyle}>
                                <Button title="Account normale" onPress={() => this.props.navigation.navigate('RegistrazioneNormale')} />
                            </View>
                            <View style={styles.buttonStyle}>
                                <Button title="Account petsitter" onPress={() => this.props.navigation.navigate('RegistrazionePetsitter')}/>
                            </View>
